...
void canny_cpu(const char * filename, const char * output_filename, float* kernel_h, float* kernel_v, float* gaussian_kernel, float sigma, int kernel_size, int kernel_radius, float low_threshold_ratio, float highthreshold_ratio, bool output);
